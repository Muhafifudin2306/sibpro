    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="d-flex justify-content-between align-items-center pb-3">
                ...
                <div class="action-content">
                    ...
                    <a href="{{ url('/setting/packages/add') }}">
                        <button class="btn btn-primary" data-toggle="modal" data-target="#relationModal">{{
                            __('+ Tambah Data') }}</button>
                    </a>
                    @endcan
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="mb-2 mx-1">
                                                    <button class="btn btn-primary">{{ $attribute->attribute_name
                                                        }}</button>
                                                </div>
                                                @endforeach
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="mb-2 mx-1">
                                                    <button class="btn btn-warning">{{ $credit->credit_name }}</button>
                                                </div>
                                                @endforeach
                                            </div>
                                        </td>
            ...
            <div class="d-flex justify-content-between align-items-center pb-3">
                ...
                <div class="action-content">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#attributeModal">{{ __('+ Tambah
                        Data') }}</button>
                </div>
                @endcan
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center pb-3">
                ...
                <div class="action-content">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#creditModal">{{ __('+ Tambah
                        Data') }}</button>
                </div>
                @endcan
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center pb-3">
                ...
                <div class="action-content">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#categoryModal">{{ __('+ Tambah
                        Data') }}</button>
                </div>
                @endcan
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="vendor_id" required="">
                            ...
                            <option value="{{ $vendor->id }}" {{ $vendor->id == $item->vendor_id ? 'selected' : '' }}>
...
<div class="modal fade" tabindex="-1" role="dialog" id="creditEdit{{ $item->id }}">
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="update-form" data-action="{{ url('/setting/credit/update/' . $item->id) }} }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="credit_name">{{ __('Nama Atribut') }}</label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="categoryModal{{ $item->slug }}">
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="update-form" data-action="{{ url('/setting/category/update/' . $item->id) }} }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="category_name">{{ __('Nama Kategori') }}</label>
